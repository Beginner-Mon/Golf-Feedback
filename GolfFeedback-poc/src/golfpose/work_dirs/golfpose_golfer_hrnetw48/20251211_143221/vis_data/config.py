...
launcher = 'none'
load_from = 'golfpose_checkpoints/golfpose_golfer_hrnetw48.pth'
log_level = 'INFO'
log_processor = dict(
...
optim_wrapper = dict(optimizer=dict(lr=0.0001, type='Adam'))
param_scheduler = [
    dict(
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='golfswing/',
        metainfo=dict(
            from_file='configs/mmpose/_base_/datasets/golfswing_golfer.py'),
        pipeline=[
            dict(type='LoadImage'),
...
test_evaluator = dict(
    ann_file='golfswing/coco/hscc_golf_kps22_2d_test.json', type='CocoMetric')
...
work_dir = './work_dirs\\golfpose_golfer_hrnetw48'
